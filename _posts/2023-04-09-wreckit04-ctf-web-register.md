...
<a id="gmbr1337"></a>
![register](./register/99.png)

ok! sekarang kita coba apakah bisa melakukan verifikasi

![register](./register/9.png)

Woaaahhh Berhasil

![register](./register/010.gif)
